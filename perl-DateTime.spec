...
BuildRequires:  %{?scl_prefix}perl(DateTime::Locale) >= 0.41
BuildRequires:  %{?scl_prefix}perl(DateTime::TimeZone) >= 1.09
BuildRequires:  %{?scl_prefix}perl(integer)
BuildRequires:  %{?scl_prefix}perl(overload)
BuildRequires:  %{?scl_prefix}perl(Params::Validate) >= 0.76
...
Provides:       %{?scl_prefix}perl(DateTimePP) = %{version}
Provides:       %{?scl_prefix}perl(DateTimePPExtra) = %{version}
...
%if ( 0%{?rhel} && 0%{?rhel} < 7 )
%filter_from_requires /perl(\(DateTime::Locale\|DateTime::TimeZone\|Params::Validate\))$/d
%filter_setup
%endif
...
%changelog
* Tue Jan 28 2014 Jitka Plesnikova <jplesnik@redhat.com> - 2:1.06-3
- Fix license tag
- Resolves: rhbz#1058692

* Tue Jan 28 2014 Jitka Plesnikova <jplesnik@redhat.com> - 2:1.06-2
- Update license tag
- Resolves: rhbz#1058692

* Tue Jan 28 2014 Jitka Plesnikova <jplesnik@redhat.com> - 2:1.06-1
- 1.06 bump
- Resolves: rhbz#1058359

* Thu Dec 05 2013 Jitka Plesnikova <jplesnik@redhat.com> - 2:1.03-5
- Updated filter
- Resolves: rhbz#1038695

* Wed Nov 20 2013 Jitka Plesnikova <jplesnik@redhat.com> - 2:1.03-4
- Rebuilt for SCL
